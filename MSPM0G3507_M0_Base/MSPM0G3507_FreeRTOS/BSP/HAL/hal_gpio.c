...
/**
 * @brief 初始化函数 hal_gpio_init_output，完成对应模块的功能处理。
 * @param cfg 函数参数 cfg。
 * @return 函数执行结果。
 */
...
/**
 * @brief 初始化函数 hal_gpio_init_input，完成对应模块的功能处理。
 * @param cfg 函数参数 cfg。
 * @param pull 函数参数 pull。
 * @return 函数执行结果。
 */
...
/**
 * @brief 设置函数 hal_gpio_set_pin，完成对应模块的功能处理。
 * @param port 函数参数 port。
 * @param pin 函数参数 pin。
 * @return 函数执行结果。
 */
...
/**
 * @brief 清除函数 hal_gpio_clear_pin，完成对应模块的功能处理。
 * @param port 函数参数 port。
 * @param pin 函数参数 pin。
 * @return 函数执行结果。
 */
...
/**
 * @brief 写入函数 hal_gpio_write_pin，完成对应模块的功能处理。
 * @param port 函数参数 port。
 * @param pin 函数参数 pin。
 * @param high 函数参数 high。
 * @return 函数执行结果。
 */
...
/**
 * @brief 读取函数 hal_gpio_read_pin，完成对应模块的功能处理。
 * @param port 函数参数 port。
 * @param pin 函数参数 pin。
 * @return 函数执行结果。
 */
...
/**
 * @brief 读取函数 hal_gpio_read_output_latch，完成对应模块的功能处理。
 * @param port 函数参数 port。
 * @param pin 函数参数 pin。
 * @return 函数执行结果。
 */
bool hal_gpio_read_output_latch(hal_gpio_port_t port, uint32_t pin)
{
    ...
    /* DOUT是输出锁存器，不是引脚物理电平反馈。 */
    return ((regs->DOUT31_0 & pin) != 0U);
}

/**
 * @brief 执行函数 hal_gpio_toggle_pin，完成对应模块的功能处理。
 * @param port 函数参数 port。
 * @param pin 函数参数 pin。
 * @return 函数执行结果。
 */
...
/**
 * @brief 设置函数 hal_gpio_set_direction，完成对应模块的功能处理。
 * @param cfg 函数参数 cfg。
 * @param dir 函数参数 dir。
 * @return 函数执行结果。
 */
