 ...
 *          ti_msp_dl_config.h(SysConfig生成) 和FreeRTOSConfig.h 保持独立。
 *
 * 配置分区:
 *   1  版本信息        7  ADC配置
 *   2  系统参数        8  IMU配置
 ...
 * 注意: ti_msp_dl_config.h 已定义LED_PORT (GPIOA), 此处重定义为
