...
#define MPU6050							//配置文件使用的芯片为MPU6050
#define MOTION_DRIVER_TARGET_MSP430		//此文件适配,仿真MSP430平台(而非移植STM32F4)
...
//得到dmp处理后的数据(注意,这个函数需要比较堆栈,分部式定义在头文件里面)
